...
const Sugestions = () => {
    ...
    const [email] = useState(user?.email || ""); // Inicializar email con el email del usuario autenticado
    ...
    const handleSubmit = (e) => {
        ...
        .then((response) => {
            ...
            setMessage("");
            setConcept("");
            //AQUI ALERTA DE CORREO ENVIADO
        })
        .catch((error) => {
            console.log("FAILED...", error.text);
            //AQUI ALERTA DE CORREO NO ENVIADO ERROR
        });
    };
